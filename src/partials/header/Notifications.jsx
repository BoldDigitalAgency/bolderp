          ...
          <ul>
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">💵 <span className="font-medium text-slate-800">Payment</span> Vous devez payer ce mois-ci.</span>
            ...
            <li className="border-b border-slate-200 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">❌ <span className="font-medium text-slate-800">Alerte du systéme</span> Votre session est expiré, veuillez payer vos factures</span>
