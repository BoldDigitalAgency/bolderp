        ...
        if (response != undefined) {
            ...
            if (whoami.user != undefined) {
                if(whoami.user.confirmed) {
                    ...
                    Cookies.set("user", JSON.stringify(whoami.user))
            ...
            <div className="grid lg:grid-cols-3">
                <div className="hidden lg:block col-span-2 h-screen">
                    <figure className="h-screen">
                        <img src="/src/images/login_cover.jpg" className="w-full h-full bg-cover"/>
                    </figure>
                </div>
                <div>
                    ...
                    <label htmlFor="connect">
                        <input type="submit" value="connect" name="connect" className="bg-blue-500 text-white p-2 px-5 rounded-md shadow-sm border border-gray-300"/>
                    </label>
                </form>
            </div>
        </div>
